...
cdef class AbstractState:
    ...
    cpdef set_binary_interaction_double(self, string_or_size_t CAS1, string_or_size_t CAS2, string parameter,
                                        double val):
    ...
    cpdef double get_binary_interaction_double(self, string_or_size_t CAS1, string_or_size_t CAS2,
                                               string parameter) except*:
    ...
    cpdef set_binary_interaction_string(self, string_or_size_t CAS1, string_or_size_t CAS2, string parameter,
                                        string val):
    ...
    cpdef update_with_guesses(self, constants_header.input_pairs ipair, double Value1, double Value2,
                              PyGuessesStructure guesses):
        """ Update function - wrapper of c++ function :cpapi:`CoolProp::AbstractState::update` """
    ...
    cpdef CoolPropDbl first_partial_deriv(self, constants_header.parameters OF, constants_header.parameters WRT,
                                          constants_header.parameters CONSTANT) except*:
    ...
    cpdef CoolPropDbl second_partial_deriv(self, constants_header.parameters OF, constants_header.parameters WRT1,
                                           constants_header.parameters CONSTANT1, constants_header.parameters WRT2,
                                           constants_header.parameters CONSTANT2) except*:
    ...
    cpdef CoolPropDbl first_saturation_deriv(self, constants_header.parameters OF,
                                             constants_header.parameters WRT) except*:
    ...
    cpdef CoolPropDbl second_saturation_deriv(self, constants_header.parameters OF1, constants_header.parameters WRT1,
                                              constants_header.parameters WRT2) except*:
    ...
    cpdef double first_two_phase_deriv(self, constants_header.parameters Of, constants_header.parameters Wrt,
                                       constants_header.parameters Constant) except*:
    ...
    cpdef double second_two_phase_deriv(self, constants_header.parameters Of1, constants_header.parameters Wrt1,
                                        constants_header.parameters Constant1, constants_header.parameters Wrt2,
                                        constants_header.parameters Constant2) except*:
    ...
    cpdef double first_two_phase_deriv_splined(self, constants_header.parameters Of, constants_header.parameters Wrt,
                                               constants_header.parameters Constant, double x_end) except*:
    ...
    cpdef double saturation_ancillary(self, constants_header.parameters param, int Q, constants_header.parameters given,
                                      double value) except*:
